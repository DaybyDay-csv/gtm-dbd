...
export const SignupGate = ({ onComplete }: SignupGateProps) => {
  ...
  return (
    <Card className="w-full max-w-md p-6 space-y-6 border-2 border-primary/20 shadow-2xl bg-background sticky top-1/4 z-50">
      <div className="text-center space-y-2">
        ...
        <div className="flex items-center justify-center gap-2 text-xs text-muted-foreground">
          <button
            ...
            disabled={isLoading}
          >
            {isSignUp ? "¿Ya tienes cuenta? Inicia sesión" : "¿Nuevo? Regístrate gratis"}
          </button>
        </div>
