...
export const SignupGate = ({ onComplete }: SignupGateProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/60 backdrop-blur-sm">
      <Card className="w-full max-w-md p-8 space-y-6 border-2 border-primary/20 shadow-2xl relative z-50 bg-background">
        <div className="text-center space-y-2">
          ...
          <p className="text-muted-foreground">
            {isSignUp
              ? "Create a free account to save and continue your personalized market analysis"
        ...
        <p className="text-xs text-center text-muted-foreground">
          Your analysis will be saved securely and remain private
        </p>
      </Card>
    </div>
  );
